...
<body class="font-sans antialiased">
    ...
    <div class="mobile-menu" id="mobile-menu">
        ...
        <div class="py-4">
            ...
            <!-- About Submenu -->
            <button class="mobile-submenu-toggle" onclick="toggleMobileSubmenu('about-submenu')">
                About
                <i class="fas fa-chevron-down transition-transform duration-200" id="about-chevron"></i>
            </button>
            <div class="mobile-submenu" id="about-submenu">
                <a href="#about-us" class="mobile-submenu-link">Our Story</a>
                <a href="#vision-mission" class="mobile-submenu-link">Vision & Mission</a>
                <a href="#subsidiaries" class="mobile-submenu-link">Subsidiaries</a>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function closeMenu() {
                ...
                document.querySelectorAll('.mobile-submenu-toggle i').forEach(chevron => {
